...
/// Silent logging callback that discards all messages
pub unsafe extern "C" fn silent_log_callback(_level: u32, _text: *const i8, _user_data: *mut std::os::raw::c_void) {
